...
ActiveRecord::Schema.define(:version => 20150109014628) do
  ...
  create_table "eventhosts", :force => true do |t|
    t.integer  "event_id"
    t.integer  "user_id"
    t.boolean  "admin"
    t.boolean  "creator"
  ...
  add_index "eventhosts", ["event_id"], :name => "index_eventhosts_on_event_id"
  add_index "eventhosts", ["user_id"], :name => "index_eventhosts_on_user_id"
  ...
  add_index "product_discounts", ["product_id"], :name => "index_product_discounts_on_product_id"
